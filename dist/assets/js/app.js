...
/* harmony import */ var _empresa__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./empresa */ "./src/js/empresa.js");
/* harmony import */ var _prods__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./prods */ "./src/js/prods.js");
...
lenis.on("scroll", function (_ref) {
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger.update();
  if (scroll > 20) {
...
gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.ticker.add(function (time) {
  lenis.raf(time * 1000);
});
gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.ticker.lagSmoothing(0);
...
if (document.getElementById("as__home")) {
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeBanners)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap);
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomePropositios)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeServicios)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeCifras)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeDocumentos)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeBlog)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
}
(0,_general__WEBPACK_IMPORTED_MODULE_2__.setTop)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
(0,_general__WEBPACK_IMPORTED_MODULE_2__.setQue)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
(0,_general__WEBPACK_IMPORTED_MODULE_2__.setGestion)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
(0,_general__WEBPACK_IMPORTED_MODULE_2__.setAyuda)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
(0,_general__WEBPACK_IMPORTED_MODULE_2__.setDocumentosInt)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);

//EMPRESA
if (document.getElementById("as__nuestra_empresa")) {
  (0,_home__WEBPACK_IMPORTED_MODULE_1__.setHomeServicios)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_empresa__WEBPACK_IMPORTED_MODULE_3__.setPropositios)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_empresa__WEBPACK_IMPORTED_MODULE_3__.setComo)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
}
//PRODS
(0,_prods__WEBPACK_IMPORTED_MODULE_4__.set_destacados)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
(0,_prods__WEBPACK_IMPORTED_MODULE_4__.set_listado)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
if (document.getElementById("as__renta_vitalicia") || document.getElementById("as__seguro_previsional") || document.getElementById("as__rv_sobreviviencia") || document.getElementById("as__rv_invalidez")) {
  (0,_prods__WEBPACK_IMPORTED_MODULE_4__.setRV_auxilio)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
  (0,_prods__WEBPACK_IMPORTED_MODULE_4__.setRV_destacados)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger);
}

//CALENDAR

(0,_calendar__WEBPACK_IMPORTED_MODULE_5__.setCalendar)(gsap__WEBPACK_IMPORTED_MODULE_6__.gsap);
...
function setPropositios(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.from(".as_em_proposito .as__title_section", {
      ...
      opacity: 0,
      y: 20
    }, (_tl$from$addLabel$fro = {
      opacity: 1,
      y: 0,
      duration: 4
    }, _defineProperty(_tl$from$addLabel$fro, "opacity", 1), _defineProperty(_tl$from$addLabel$fro, "stagger", 0.4), _tl$from$addLabel$fro), "startp").fromTo(".as_em_proposito img", {
      opacity: 0,
      y: 20
    }, {
      y: 0,
...
function setComo(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.fromTo(".as__como .as__como_item .anim", {
      ...
      xPercent: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo, "opacity", 1), _defineProperty(_tl$fromTo, "stagger", 0.4), _tl$fromTo), "-=2");
    var scroll = ScrollTrigger.create({
      animation: tl,
      trigger: id,
      start: "-20% bottom",
...
function setQue(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.from(".as__que_es .as__title_section", {
      ...
      y: 0,
      duration: 4
    }, _defineProperty(_tl$from$addLabel$fro, "opacity", 1), _defineProperty(_tl$from$addLabel$fro, "stagger", 0.4), _tl$from$addLabel$fro), "startp").fromTo(".as__que_es img", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
function setGestion(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.addLabel("startp", 0).fromTo(".as__gestion h3", {
      ...
      opacity: 0,
      y: 20
    }, (_tl$addLabel$fromTo$f = {
      opacity: 1,
      y: 0,
      duration: 4
    }, _defineProperty(_tl$addLabel$fromTo$f, "opacity", 1), _defineProperty(_tl$addLabel$fromTo$f, "stagger", 0.4), _tl$addLabel$fromTo$f), "startp-=2").fromTo(".as__gestion img", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
function setAyuda(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.addLabel("startp", 0).fromTo(".as__ayuda .as__ayuda_ilus", {
      ...
      opacity: 0,
      y: 20
    }, (_tl$addLabel$fromTo$f2 = {
      opacity: 1,
      y: 0,
      duration: 4
    }, _defineProperty(_tl$addLabel$fromTo$f2, "opacity", 1), _defineProperty(_tl$addLabel$fromTo$f2, "stagger", 0.4), _tl$addLabel$fromTo$f2), "startp-=2").fromTo(".as__ayuda img", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
function setHomePropositios(gsap, ScrollTrigger) {
  if (document.getElementById("home_proposito")) {
    ...
    tl.from(".as_proposito .as__title_section", {
      ...
      opacity: 0,
      y: 20
    }, (_tl$from$fromTo$fromT = {
      opacity: 1,
      y: 0,
      duration: 1
    }, _defineProperty(_tl$from$fromTo$fromT, "opacity", 1), _defineProperty(_tl$from$fromTo$fromT, "stagger", 0.4), _tl$from$fromTo$fromT), "-=8").from(".as__proposito_link .as__button", {
      opacity: 0,
      y: 20,
      duration: 1
...
function setHomeCifras(gsap, ScrollTrigger) {
  if (document.getElementById("home_cifras")) {
    ...
    tl.fromTo(".as__cifras .as__cifras_content .as__cifras_content_cifra", {
      ...
      y: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo, "opacity", 1), _defineProperty(_tl$fromTo, "stagger", 0.4), _tl$fromTo), "-=1");
    var scroll = ScrollTrigger.create({
      animation: tl,
...
function setHomeDocumentos(gsap, ScrollTrigger) {
  if (document.getElementById("home_documentos")) {
    ...
    tl.from(".as__documentos .as__documentos_img", (_tl$from = {
      opacity: 0,
      yPercent: 20,
      duration: 8
    }, _defineProperty(_tl$from, "opacity", 1), _defineProperty(_tl$from, "ease", "power4.out"), _tl$from), "+=2");
    tl.fromTo(".as__documentos .as__documentos_content h4 span", {
      ...
      y: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo2, "opacity", 1), _defineProperty(_tl$fromTo2, "stagger", 0.4), _tl$fromTo2), "-=3");
...
function setHomeBlog(gsap, ScrollTrigger) {
  if (document.getElementById("home_blog")) {
    ...
    tl.fromTo(".as__blog .as__blog_posts .as__post_small a", {
      ...
      xPercent: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo4, "opacity", 1), _defineProperty(_tl$fromTo4, "stagger", 0.4), _tl$fromTo4), "-=2");
    var scroll = ScrollTrigger.create({
      animation: tl,
...
function setRV_auxilio(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.addLabel("startp", 0).fromTo(".as__rv_auxilio .as__rv_auxilio_content .prop_anim", {
      ...
      y: 0,
      duration: 4
    }, _defineProperty(_tl$addLabel$fromTo, "opacity", 1), _defineProperty(_tl$addLabel$fromTo, "stagger", 0.4), _tl$addLabel$fromTo), "startp").fromTo(".as__rv_auxilio_ilustra svg", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
function set_listado(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.addLabel("startp", 0).fromTo(".as__listado .as__listado_content .prop_anim", {
      opacity: 0,
      y: -20
    }, (_tl$addLabel$fromTo2 = {
      opacity: 1,
      y: 0,
      duration: 4
    }, _defineProperty(_tl$addLabel$fromTo2, "opacity", 1), _defineProperty(_tl$addLabel$fromTo2, "stagger", 0.4), _tl$addLabel$fromTo2), "startp").fromTo(".as__listado_ilustra svg", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/js-year-calendar/dist/js-year-calendar.css":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/js-year-calendar/dist/js-year-calendar.css ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_js_year_calendar_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./js-year-calendar.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/js-year-calendar/dist/js-year-calendar.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_js_year_calendar_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_7_oneOf_1_use_2_js_year_calendar_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
/******/ 	__webpack_require__.O(undefined, ["dist/assets/css/portal","dist/assets/css/app"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["dist/assets/css/portal","dist/assets/css/app"], () => (__webpack_require__("./src/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/assets/css/portal","dist/assets/css/app"], () => (__webpack_require__("./src/css/portal.css")))
