...
var menu_nav = document.getElementById("navbar-default");
...
function setGestion(gsap, ScrollTrigger) {
  ...
  if (id) {
    ...
    tl.addLabel("startp", 0).fromTo(".as__gestion .as__gestion_content .prop_anim", {
      opacity: 0,
      y: 20
    }, (_tl$addLabel$fromTo = {
      opacity: 1,
      y: 0,
      duration: 4
    }, _defineProperty(_tl$addLabel$fromTo, "opacity", 1), _defineProperty(_tl$addLabel$fromTo, "stagger", 0.4), _tl$addLabel$fromTo), "startp").fromTo(".as__gestion img", {
      opacity: 0,
      y: 40
    }, {
      y: 0,
...
function setHomePropositios(gsap, ScrollTrigger) {
  if (document.getElementById("home_proposito")) {
    ...
    tl.fromTo(".as_proposito .as__marquee .as__marquee_to_left", {
      x: 0
    }, {
      x: toMarquee,
      duration: 20,
    ...
    tl.fromTo(".as_proposito .as_proposito_content .prop_anim", {
      opacity: 0,
      y: 20
    }, (_tl$fromTo = {
      opacity: 1,
      y: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo, "opacity", 1), _defineProperty(_tl$fromTo, "stagger", 0.4), _tl$fromTo), "-=8");
    tl.from(".as__proposito_link .as__button", {
      opacity: 0,
      y: 20,
      duration: 1
    }, "-=10");
    tl.from(".as__proposito_ilus img", {
      opacity: 0,
      y: 50,
      duration: 4
    }, "-=3");
...
function setHomeCifras(gsap, ScrollTrigger) {
  if (document.getElementById("home_cifras")) {
    ...
    tl.fromTo(".as__cifras .as__cifras_content .as__cifras_content_cifra", {
      ...
      y: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo2, "opacity", 1), _defineProperty(_tl$fromTo2, "stagger", 0.4), _tl$fromTo2), "-=1");
    var scroll = ScrollTrigger.create({
      animation: tl,
      ...
      onEnter: function onEnter() {
        ...
        gsap.fromTo(counters, {
          ...
          onUpdate: function onUpdate() {
            ...
            document.getElementById("home_cifras_colaboradores").innerHTML = counters.colaboradores;
...
function setHomeDocumentos(gsap, ScrollTrigger) {
  if (document.getElementById("home_documentos")) {
    ...
    tl.fromTo(".as__documentos .as__documentos_content h4 span", {
      ...
      y: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo3, "opacity", 1), _defineProperty(_tl$fromTo3, "stagger", 0.4), _tl$fromTo3), "-=3");
...
function setHomeBlog(gsap, ScrollTrigger) {
  if (document.getElementById("home_blog")) {
    ...
    tl.fromTo(".as__blog .as__blog_posts .as__post_small a", {
      ...
      xPercent: 0,
      duration: 1
    }, _defineProperty(_tl$fromTo5, "opacity", 1), _defineProperty(_tl$fromTo5, "stagger", 0.4), _tl$fromTo5), "-=2");
    var scroll = ScrollTrigger.create({
      animation: tl,
